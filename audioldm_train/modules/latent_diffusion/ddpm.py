...
class DDPM(pl.LightningModule):
    ...
    def __init__(
        ...
        self.clap = CLAPAudioEmbeddingClassifierFreev2(
            pretrained_path="/Volumes/gen_audio_catalog/volumes/ziyi/Checkpoint_AudioLDM2/clap_music_speech_audioset_epoch_15_esc_89.98.pt", #"data/checkpoints/clap_music_speech_audioset_epoch_15_esc_89.98.pt"
