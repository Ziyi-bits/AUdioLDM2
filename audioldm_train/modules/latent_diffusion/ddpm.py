...
class DDPM(pl.LightningModule):
    ...
    def __init__(
        ...
        self.clap_audio = CLAPAudioEmbeddingClassifierFreev2(
            pretrained_path=r"/Volumes/gen_audio_catalog/volumes/ziyi/Checkpoint_AudioLDM2/clap_music_speech_audioset_epoch_15_esc_89.98.pt".replace("\\", "/"), # "data/checkpoints/clap_music_speech_audioset_epoch_15_esc_89.98.pt"
