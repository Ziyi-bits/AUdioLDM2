...
#     text_data = ["a dog barking"]
#     text_emb = model(text_data)
#     print(f"Text embedding shape: {text_emb.shape}")  # Expect [1, 1, 512]
#
#     # 2) Switch to AUDIO mode
#     print("\n>>> Testing AUDIO mode...")
#     model.embed_mode = "audio"
#
#     # Create dummy audio: batch of 1, mono, 10.24s at 16kHz
#     sr = 16000
#     duration = 10.24
#     audio_data = torch.randn(1, 1, int(sr * duration))
#
#     audio_emb = model(audio_data)
#     print(f"Audio embedding shape: {audio_emb.shape}")  # Expect [1, 1, 512]
